...
class Server:
    ...
    def __init__(self, address, domain, log_file, top_servers, primary_server):
...
def main(config_file):
    ...
    if server_info is None:
        ...
        return
    server = Server(server_info['DD'][0], server_info['ADDRESS'],server_info['LG'], server_info['ST'], server_info['SP'])
